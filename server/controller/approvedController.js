...
var approvedController = {
    ...
    getHopdongAccept1: function getHopdongAccept1(pageNumber, pageSize, callback) {
        let limit = pageSize;
        let offset = pageSize * (pageNumber - 1);
    ...
    getHopdongAccept2: function getHopdongAccept2(pageNumber, pageSize, callback) {
        let limit = pageSize;
        let offset = pageSize * (pageNumber - 1);
    ...
    getHopdongAccept3: function getHopdongAccept3(pageNumber, pageSize, callback) {
        let limit = pageSize;
        let offset = pageSize * (pageNumber - 1);
    ...
    getHopdongRefuse1: function getHopdongRefuse1(pageNumber, pageSize, callback) {
        let limit = pageSize;
        let offset = pageSize * (pageNumber - 1);
    ...
    getHopdongRefuse2: function getHopdongRefuse2(pageNumber, pageSize, callback) {
        let limit = pageSize;
        let offset = pageSize * (pageNumber - 1);
    ...
    getHopdongRefuse3: function getHopdongRefuse3(pageNumber, pageSize, callback) {
        let limit = pageSize;
        let offset = pageSize * (pageNumber - 1);
