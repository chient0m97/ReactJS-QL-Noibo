...
class Groupfilter extends React.Component {
  ...
  onSearch = async () => {
    ...
    console.log('condition', all_success + ' ' + has_condition)
    if (all_success & has_condition) {
      ...
      await console.log('arr_condition_with_level sau khi convert lan dau', arr_condition_with_level)
      var first_for = false
      ...
      await console.log(first_for, ' firest for')
      if (first_for) {
        console.log('arr_condition_with_level sau khi add condition', arr_condition_with_level)
        var level_group = await level_max
        console.log(level_max, 'level max group')
        while (level_group > 0) {
        ...
        console.log('mangr  condition gheps  theo level sau khi add group', arr_condition_with_level)
      }
    } else {
      notification['error']({
    ...
    for (var dmmm = 0; dmmm < arr_condition_with_level[level_group - 2].arrayCondition.length; await dmmm++) {
      if (arr_condition_with_level[level_group - 2].arrayCondition[dmmm].type === 'gcd'
        ...
        if (arr_condition_with_level[level_group - 2].arrayCondition[dmmm].sql !== undefined) {
          ...
          console.log(arr_condition_with_level[level_group - 2].arrayCondition[dmmm].sql, 'dcm nó nữa')
        }
      }
    }
  }
  ...
  addGConditionAndreplaceMatch = async (arr_condition_with_level, level_group, level_max, condition_lv_0) => {
    ...
    if (level_group === 1) {
      ...
      console.log('arr cd', arr_cd)
      console.log('arr gcd', arr_gcd)
      ...
      console.log(end_sql, 'dcm cuois rooif')
    }
  }
